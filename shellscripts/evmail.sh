...
#Centroid: [-126.7, 52.35]
#STATIONS='BCBC CLVB'
#Cluster ID:  West
#Cluster Lon / Lat:  -124.08 50.58
#STATIONS='FALL VIB PGCB MWAB WISB KELB THAB PHC QURY BPCB TLCB TFRB SNB PACB GHNB BMSB YOUB SHB SPLB VGZ CBB LCBC KHVB '
...
# Get Stations
  ...
  echo "NET_LIST CNSN FEDNOR" >> $event"_request"
