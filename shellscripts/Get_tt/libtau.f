...
c 100  format(a)
c
CMGB      ib='/seis/ivana/Alex/Tables/iasp'
      ib='/Users/Alex/Src/Get_tt/iasp91'
 2    nb=index(ib,' ')-1
      if(nb.le.0) nb=len(ib)
CMGB      ibb='/seis/ivana/Alex/bin/iasp.hed'
      ibb='/Users/Alex/Src/Get_tt/iasp91.hed'
      call assign(lu,mode,ibb)
      return
      end
...
cmgb      call abort('Source slowness too large.')
      stop
cmgb
 4    k2=i
