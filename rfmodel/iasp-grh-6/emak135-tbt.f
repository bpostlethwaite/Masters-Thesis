...
c         discontinuities in model
      ...
      character*20 modnam
      logical first
      data rd/0.,4.,36.,75.,261.78,415.,660.,2740.,2891.5,5153.5/
      data modnam/'ak135-tbt'/, first/.true./
      if (first) then
	 first = .false.
	 do 10 i=1,nd
	    rd(i) = re-rd(i)
10       continue
 ...
 1    cpr(i)=rd(nd-i+1)
      ...
      data (z(i),vs(i),vp(i),rho(i),i=1,11) /
     +   0., 3.20222881,  5.546422996, 3.50,
     +   4., 3.20222881,  5.546422996, 3.50,
     +   4., 3.652542236, 6.326388729, 3.50,
     +  36., 3.652542236, 6.326388729, 3.50,
     +  36., 4.603203914, 7.972983056, 3.50,
     +  75., 4.603203914, 7.972983056, 3.50,
     +  75., 4.457315,    7.720296,    3.50,
     +261.78,4.457315,    7.720296,    3.50,
     +261.78,4.457315,    7.720296,    3.50,
     + 415., 4.79285,     8.3014597,   3.50,
     + 415., 5.050229,    8.747253,    3.50/

      data (z(i),vs(i),vp(i),rho(i),i=12,20) /
     + 475., 5.129916929, 8.885276759, 3.50,
     + 525., 5.229501161, 9.057761709, 3.50,
     + 575., 5.308083433, 9.193870197, 3.50,
     + 625., 5.43063088,  9.406128601, 3.50,
     + 660., 5.608742885, 9.714627644, 3.50,
     + 660., 5.93808188, 10.28505952,  3.50,
     + 725., 6.127701302,10.61348999,  3.50,
     + 775., 6.241520328,10.81063032,  3.50,
     + 825., 6.281658723,10.88015206,  3.50/

      data (z(i),rho(i),vp(i),vs(i),i=21,26) /
     ...
     + 1106.50,  4.6467, 11.6265,  6.4514/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=27,36) /
     ...
     + 1601.50,  4.9069, 12.3181,  6.7323/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=37,46) /
     ...
     + 2096.50,  5.1499, 12.9093,  6.9625/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=47,56) /
     ...
     + 2591.50,  5.3748, 13.4741,  7.1804/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=57,66) /
     ...
     + 2989.66, 10.0722,  8.1283,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=67,76) /
     ...
     + 3492.97, 10.7647,  8.9461,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=77,86) /
     ...
     + 3996.28, 11.3127,  9.5306,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=87,96) /
     ...
     + 4499.60, 11.7373,  9.9410,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=97,106) /
     ...
     + 5002.91, 12.0593, 10.2565,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=107,116) /
     ...
     + 5458.17, 12.8387, 11.1316,  3.5765/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=117,126) /
     ...
     + 5965.30, 12.9779, 11.2364,  3.6498/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=127,134) /
