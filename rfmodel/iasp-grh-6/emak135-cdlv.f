...
c         discontinuities in model
      ...
      parameter (re=6371.0,nd=10)
      dimension cpr(nd),rd(nd)
      character*(*) name
      character*20 modnam
      logical first
      data rd/0.,4.,36.,125.,250.,415.,660.,2740.,2891.5,5153.5/
      data modnam/'ak135-cdlv'/, first/.true./
      if (first) then
	 first = .false.
	 do 10 i=1,nd
	    rd(i) = re-rd(i)
10       continue
 ...
 1    cpr(i)=rd(nd-i+1)
      ...
      data (z(i),vs(i),vp(i),rho(i),i=1,10) /
     +   0., 3.19247943,  5.529536576, 3.50,
     +   4., 3.19247943,  5.529536576, 3.50,
     +   4., 3.64142185,  6.307127657, 3.50,
     +  36., 3.64142185,  6.307127657, 3.50,
     +  36., 4.589189181, 7.948708827, 3.50,
     +  75., 4.589189181, 7.948708827, 3.50,
     + 125., 4.655028776, 8.06274635,  3.50,
     + 125., 4.490858,    7.778395,    3.50,
     + 250., 4.490858,    7.778395,    3.50,
     + 250., 4.490858,    7.778395,    3.50/

      data (z(i),vs(i),vp(i),rho(i),i=11,19) /
     + 415., 4.786898,    8.29115,     3.50,
     + 415., 5.039585029, 8.72881732,  3.50,
     + 475., 5.119105109, 8.866550138, 3.50,
     + 525., 5.234982695, 9.067256005, 3.50,
     + 575., 5.318720813, 9.212294679, 3.50,
     + 625., 5.438466872, 9.419700938, 3.50,
     + 660., 5.616751824, 9.728499533, 3.50,
     + 660., 5.946561095,10.29974595,  3.50,
     + 725., 6.136451281,10.6286454,   3.50/

      data (z(i),vs(i),vp(i),rho(i),i=20,21) /
     + 775., 6.245751531,10.81795898,  3.50,
     + 825., 6.285917136,10.88752785,  3.50/

      data (z(i),rho(i),vp(i),vs(i),i=22,27) /
     +  859.00,  4.4650, 11.2228,  6.2817,
     ...
     + 1106.50,  4.6467, 11.6265,  6.4514/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=28,37) /
     ...
     + 1601.50,  4.9069, 12.3181,  6.7323/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=38,47) /
     ...
     + 2096.50,  5.1499, 12.9093,  6.9625/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=48,57) /
     ...
     + 2591.50,  5.3748, 13.4741,  7.1804/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=58,67) /
     ...
     + 2989.66, 10.0722,  8.1283,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=68,77) /
     ...
     + 3492.97, 10.7647,  8.9461,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=78,87) /
     ...
     + 3996.28, 11.3127,  9.5306,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=88,97) /
     ...
     + 4499.60, 11.7373,  9.9410,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=98,107) /
     ...
     + 5002.91, 12.0593, 10.2565,  0.0000/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=108,117) /
     ...
     + 5458.17, 12.8387, 11.1316,  3.5765/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=118,127) /
     ...
     + 5965.30, 12.9779, 11.2364,  3.6498/
      ...
      data (z(i),rho(i),vp(i),vs(i),i=128,135) /
