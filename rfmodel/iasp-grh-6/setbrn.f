...
c   sPP and sP'P'.
         ...
         call mkdbr(1,lbb(1),+2,3,1,1,sref)
      endif
c   S (up-going branch).
      print *,'Layout:  do Sup'
      call mkubr(ku(2),   +2)
...
c   S3KS
      if (ocore) then
         ...
         call mkdbr(1,3,     -2,3,2,2,c3ref)
c   S4KS
         print *,'Layout:  do S4KS'
         call mkdbr(1,3,     -2,3,2,2,c4ref)
c   S5KS
         print *,'Layout:  do S5KS'
         call mkdbr(1,3,     -2,3,2,2,c5ref)
c   P3KP.
         print *,'Layout:  do P3KP'
         call mkdbr(1,3,     -1,3,1,1,c3ref)
c   P4KP.
         print *,'Layout:  do P4KP'
         call mkdbr(1,3,     -1,3,1,1,c4ref)
      endif
c   SS and S'S'.
...
c   pSS and pS'S'.
      if (odadd) then
         ...
         call mkdbr(1,lbb(1),+1,3,2,2,sref)
c   sSS and sS'S'.
         print *,'Layout:  do pSS and pS''S'''
         call mkdbr(1,lbb(2),+2,3,2,2,sref)
      endif
