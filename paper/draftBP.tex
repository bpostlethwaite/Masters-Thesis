...
The bulk crustal composition of Canada shows a $frac{V_P}{V_S}$ ratio of $Z$. When compared to the granite - tonalitic - mafic gneiss spectrum this value in very close to the tonalitic gneiss value of $Y$. Compared to other bulk crustal averages this value appears to be X. [Find estimates of bulk averages].

Data across geological provinces

Archean versus Proterozoic
